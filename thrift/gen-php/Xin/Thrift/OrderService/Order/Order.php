...
class Order {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::I32) {
            $xfer += $input->readI32($this->totalFee);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->totalFee !== null) {
      $xfer += $output->writeFieldBegin('totalFee', TType::I32, 3);
      $xfer += $output->writeI32($this->totalFee);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->isDeleted !== null) {
      $xfer += $output->writeFieldBegin('isDeleted', TType::BYTE, 4);
